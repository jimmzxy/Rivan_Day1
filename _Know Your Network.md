...
conf t
 int vlan 1
  ip add 10.62.1.2 255.255.255.0
...
Task:
 1. CoreTAAS must have the following SVIs
   - VLAN 1
       - IP address: 10.62.1.2
       - Description: DEFAULT-VLAN
       - Status: UP

   - VLAN 10
     - IP address: 10.62.10.2
     - Description: WIFI-VLAN
     - Status: UP

   - VLAN 50
     - IP address: 10.62.50.2
     - Description: CCTV-VLAN
     - Status: UP

   - VLAN 100
     - IP address: 10.62.100.2
...
conf t
 int vlan 1
  ...
  exit
 int vlan 10
  ip add 10.62.10.2 255.255.255.0
  description WIFI-VLAN
  no shut
  exit
 int vlan 50
  ip add 10.62.50.2 255.255.255.0
  description CCTV-VLAN
  no shut
  exit
 int vlan 100
  ip add 10.62.100.2 255.255.255.0
  description VOICE-VLAN
  no shut
 end
~~~
...
conf t
 ...
 int gi 0/1
  no shut
  no switchport
  ip add 10.62.62.4 255.255.255.0
 int vlan 1
  no shut
  ip add 10.62.1.4 255.255.255.0
  desc DEFAULT-VLAN
 int vlan 10
  no shut
  ip add 10.62.10.4 255.255.255.0
  desc WIFI-VLAN
 int vlan 50
  no shut
  ip add 10.62.50.4 255.255.255.0
  desc CCTV-VLAN
 int vlan 100
  no shut
  ip add 10.62.100.4 255.255.255.0
  desc VOICE-VLAN
 end
~~~
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.62.1.1 10.62.1.100
 ip dhcp excluded-address 10.62.10.1 10.62.10.100
 ip dhcp excluded-address 10.62.50.1 10.62.50.100
 ip dhcp pool POOLDATA
  network 10.62.1.0 255.255.255.0
  default-router 10.62.1.4
  domain-name MGMTDATA.COM
  dns-server 10.62.1.10
 ip dhcp pool POOLWIFI
  network 10.62.10.0 255.255.255.0
  default-router 10.62.10.4
  domain-name WIFIDATA.COM
  dns-server 10.62.1.10
  option 43 ip 10.62.10.62
 ip dhcp pool POOLCCTV
  network 10.62.50.0 255.255.255.0
  default-router 10.62.50.4
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.62.100.1 10.62.100.100
 ip dhcp pool POOLVOICE
  network 10.62.100.0 255.255.255.0
  default-router 10.62.100.4
...
!@dhcp
conf t
 ip dhcp excluded-add 10.62.1.1 10.62.1.100
 ip dhcp excluded-add 10.62.10.1 10.62.10.100
 ip dhcp excluded-add 10.62.50.1 10.62.50.100
 ip dhcp excluded-add 10.62.100.1 10.62.100.100
 ip dhcp pool POOLDATA
  network 10.62.1.0 255.255.255.0
  default-router 10.62.1.4
  domain-name MGMTDATA.COM
...
conf t
 ...
 int fa 0/0
  no shut
  ip add 10.62.100.8 255.255.255.0
 end
~~~
...
config t
 dial-peer voice 69 voip
  ...
  destination-pattern 6269
  session target ipv4:10.62.100.8
  incoming called-number 6269
...
conf t
 ...
 ip route 10.62.0.0 255.255.0.0 10.62.62.4 254
 end
~~~
...
conf t
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.62.100.4 254
 end
~~~
...
!@CoreBABA
conf t
 ip route 0.0.0.0 0.0.0.0 10.62.62.1 254
 end
~~~
